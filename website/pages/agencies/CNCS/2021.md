...
- 2022
- 2021
detail_DNP_Discussion: The agency does access some DNP systems throughout the year
  to ensure awardees are eligible to receive federal funding. It is not used in its
  improper payments assessment. The agency is currently exploring options to integrate
  this into the payment integrity program.
detail_DNP_Frequency_Correction: null
