...
- 2022
- 2021
detail_DNP_Discussion: 'Treasury screens each of GSA''s summary schedules against
  the Do Not Pay system daily.  Very few matches are returned.  Most matches are for
  salary payments and are false positives (meaning a valid reason for the payment).
