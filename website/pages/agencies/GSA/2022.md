...
detail_Aging_of_Outstanding_OP_Identified_Remaining_Unrecovered: '1.79'
...
detail_DNP_Discussion: Treasury screens each of GSA's summary schedules against the
  ...
  payments and are false positives (there is a valid reason for the payment) The Financial
...
detail_Executive_Summary: "GSA continued recovery audit activities with ongoing, regional\
  \ audits of rental of space activities and continues to track claims related to\
  \ improper payments.  In FY22, GSA recovered $43.17 million in claims tracked by\
  \ Finance outside of the payment recapture audit and $3.46 million in recoveries\
  \ through payment recapture audit activities.  \n\nFinally, GSA had one scheduled\
  \ risk assessment in FY22 of the Acquisition Workforce Training program which was\
  \ completed and indicated that the program was not likely to be susceptible to significant\
  \ improper payments."
...
detail_Recovery_Additional_Details: GSA identified possible improper payments related
  to a contract modification effective in FY 22. This contract modification incorporates
  a negotiated agreement between GSA and the vendor for $5,802,885. GSA needs to research
  contract documents to determine if the negotiated amount relates to a potential
  improper payment or proper payment.
detail_Recovery_Audits_Skipped: 'Yes'
detail_Recovery_Justifications_Audits: 'Some examples of a reason a collection is
  not possible are:  lease termination, company is bankrupt, or a change in ownership.  In
  these cases, the debt is referred to the Treasury for collection after 120 days.'
