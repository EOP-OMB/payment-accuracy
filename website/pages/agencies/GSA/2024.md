...
Risks:
  ...
  - Fiscal_Year: null
    MethodologyChanged: 0
    Program_Name: Data Driven Innovation
    Slug: null
    Susceptible: 'No'
  - Fiscal_Year: null
    MethodologyChanged: 0
...
detail_DNP_Discussion: Treasury screens each of GSA's summary schedules against the
  ...
  the Death Master List is identified. The Do Not Pay initiative continues to help
  reduce improper payments at GSA.
...
detail_Executive_Summary: 'GSA was found to be compliant in the most recent OIG Annual
  ...
  22 risk assessments in FY24.  All of the risk assessments found that the programs
...
detail_Recommendations_To_Reduce_IP: The OIG did not provide any recommendations to
  further improve prevention and reduction of improper payments. The OIG did make
  one observation, noting a minor error in the summary report detailing GSA’s risk
  assessment criteria methodology. GSA agreed with the observation and immediately
  corrected the error.
detail_Recovery_Additional_Details: null
detail_Recovery_Audits_Skipped: 'Yes'
detail_Recovery_Justifications_Audits: GSA's recovery audit efforts currently target
  PBS’ “rental of space”, a known area prone to improper payments. One common issue
  that causes an improper payment to be not collectable is that when a building is
  sold or ownership is transferred, the entity GSA has a claim against may be dissolved.
  It's not unusual for companies to dissolve their LLCs after a building sale or transfer,
  making recovery of funds difficult. Additionally, GSA has encountered cases where
  companies declare bankruptcy. In these situations, claims are ranked in order of
  priority, and GSA’s claims often receive low priority among the creditors.
