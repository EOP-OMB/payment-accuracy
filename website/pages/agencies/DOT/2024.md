...
detail_Executive_Summary: "The Department of Transportation (DOT) prioritizes payment\
  \ integrity efforts and recognizes the importance of maintaining effective internal\
  \ controls to ensure proper payments. Safeguarding DOT’s assets and resources reinforces\
...
detail_Overpayment_Conditions: Grant payments continue to represent the greatest proportion
  ...
  identified when closing grant agreements funded by COVID relief sources. Since FY
...
detail_Recommendations_To_Reduce_IP: DOT’s Inspector General concluded that the agency
  was compliant with PIIA requirements as prescribed by OMB in the FY 2023 audit and
  did not make any recommendations. In addition, the OIG will issue a report in FY
  2025 with a determination on whether DOT was compliant with PIIA requirements in
  FY 2024.
detail_Recovery_Additional_Details: null
detail_Recovery_Audits_Skipped: 'Yes'
detail_Recovery_Justifications_Audits: null
detail_Recovery_Methods_Audits: Federal personnel within DOT’s Payment Integrity Center
  performed the recovery audit focusing on DOT payments made between April 2023 through
  March 2024. DOT considers all overpayments identified through the fiscal year 2024
  ...
  from the payees. In fiscal year 2024, recaptured overpayments resulting from DOT
