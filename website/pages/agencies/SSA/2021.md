...
detail_DNP_Discussion: "We do not use the Treasury Do Not Pay (DNP) system.  DNP data\
  ...
  \ System for Award Management (SAM), our public version of the Death Master File\
  \ (DMF), and Prisoner Update Processing System (PUPS).\n\nSAM:  We currently comply\
  \ with regulations to use List of Excluded Individuals/Entities (LEIE), which accomplishes\
