...
Overpayment_Amounts: '[]'
Overpayment_Amounts_Identified: '[4.41, 4.49, 9.77, 9.56]'
Overpayment_Amounts_Recovered: '[6.17, 5.23, 5.56, 10.35]'
...
detail_DNP_Discussion: In FY 2025, the Department continued its close collaboration
  ...
  monitoring efforts. This included a comprehensive review of its current DNP procedures
  and progress toward aligning with Executive Order 14247, “Modernizing Payments to
  and from America’s Bank Account,” as well as Executive Order 14249, “Protecting
  America’s Bank Account Against Fraud, Waste, and Abuse.” DNP continues to play a
  critical role in supporting the Department’s efforts to prevent and reduce improper
  payments by enhancing pre-payment and pre-award data verification, strengthening
  internal controls, and promoting more informed decision-making across programs.
  The Department maintains ongoing communication with Bureaus and Offices, emphasizing
  the importance of using the DNP Portal to verify eligibility across various data
  sources, ensuring that vendors, grantees, loan recipients, and beneficiaries are
...
detail_Executive_Summary: The Payment Integrity Information Act of 2019 (PIIA), enacted
  ...
  OMB further clarified these requirements in Memorandum M-21-19, issued on March
  5, 2021, which outlines agency responsibilities for conducting Phase 1 risk assessments
  and, where applicable, Phase 2 statistical testing. More recently, Executive Orders
  14249 and 14247, signed on March 25, 2025, further emphasized the importance of
  payment integrity by directing agencies to modernize payment systems, reduce fraud,
  and transition to electronic payments. In alignment with PIIA, the Department of
  the Interior (DOI) conducts comprehensive risk assessments on a three-year cycle
  for all programs with annual outlays exceeding $10 million. With OMB concurrence,
  DOI uses an alternative annual assessment period spanning from Q4 of the prior fiscal
  year through Q3 of the current fiscal year. In FY 2025, DOI assessed 103 programs
  totaling approximately $33.31 billion in payments. None of the programs were identified
  as being at high risk of susceptibility to significant improper payments, and no
  new programs were required to proceed to Phase 2 testing. DOI remains compliant
  with PIIA requirements and continues to monitor programs in off-cycle years. Additionally,
  DOI will conduct off-cycle risk assessments if a program undergoes significant changes
...
detail_Recovery_Not_Cost_Effective_Justification: The Department conducts recovery
  activities in accordance with OMB Circular A-123 as part of its efforts to strengthen
  payment integrity and reduce improper payments. These activities including self-reported
  overpayments, internal control reviews, Single Audit reviews, and post-payment reviews,
  serve as effective tools for identifying, reducing, and recovering improper payments.
  DOI will continue leveraging these efforts to address improper payments in a cost-effective
  and efficient manner, while also assessing whether implementing a payment recapture
  audit program would provide additional value or benefits.
