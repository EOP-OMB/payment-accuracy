...
- 2022
- 2021
detail_DNP_Discussion: USAGM receives a Do Not Pay adjudication report on a monthly
  basis from the Department of Treasury Fiscal Service.  This activity has allowed
  the agency to research and resolve all payments that may be a possible improper
  payment and implement quick corrective actions if an error was made. Also the accounts
  payable system is vetted against the Social Security Administration death master
  file and SAM master file.
