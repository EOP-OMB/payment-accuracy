...
detail_DNP_Discussion: Our financial system shared service provider, Enterprise Services
  Center (ESC) from Department of Transportation, verifies an entity against both
  the System for Award Management (SAM.gov) and the Internal Revenue Service's taxpayer
  ...
  system to make sure invoices are matched with goods received, and the payment amount
...
detail_Executive_Summary: In review of the annual program appropriations threshold
  ...
  $100 million outlay, there is no risk of significant improper payments that met
  or exceeded the existing appropriations.
