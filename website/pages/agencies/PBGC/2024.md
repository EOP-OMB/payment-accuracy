...
detail_DNP_Discussion: 'PBGC has implemented the Do Not Pay (DNP) system. DNP is used
  ...
  the Financial Operations Department (FOD) consults with
...
detail_Executive_Summary: 'The PBGC Inspector General concluded in its report issued
  on May 1, 2024, that the agency was compliant with the Payment Integrity Information
  Act of 2019 (PIIA) in the OIG''s most recent evaluation
...
detail_Recommendations_To_Reduce_IP: There were no recommendations
...
detail_Recovery_Not_Cost_Effective_Justification: 'Benefit Payments disburses over
  $5 billion in payments annually to over 800,000 participants each month.
...
detail_Recovery_Not_Cost_Effective_Programs: 'Benefit Payments
  ...
  Premium Refunds'
detail_Risks_Additional_Information: Three payment streams reviewed for FY 2024 were
  Multiemployer Special Financial Assistance Payments, Benefit Payments and Premium
  Refund Payments
