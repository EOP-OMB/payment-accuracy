...
detail_Additional_IP_Information: The Department is unique to the federal government
  ...
  Auditors audit; contracting officers provide final approval for contract compliance;  and
...
detail_Executive_Summary: "DOE’s Inspector General concluded that the agency was compliant\
  ...
  \ 2022 compliance audit for the reporting of FY 2021 payments. PIIA requires agencies\
...
detail_Recommendations_To_Reduce_IP: 'The OIG provided the following recommended actions
  to further improve prevention and reduction of improper payments and unknown payments
  in the most recent PIIA compliance Report: (1) "Update annual guidance to sites
  to include more specific direction on payment reporting sites’ collection of useful
  and consistent data to identify detailed root causes of reported improper payments
  and on developing plans to mitigate them in the future; and (2) Expand the use of
  data analytics at both Department Headquarters and payment reporting sites to better
  identify potential improper payments and the root causes for improper payments,
  especially as expenditures will increase due to IIJA, IRA, and the CHIPS Act."'
...
detail_Recovery_Not_Cost_Effective_Justification: Due to the Department's low improper
  payment rate of 0.09% and recapture rate of 89.25%, the determination was made that
  it is not cost-effective to conduct recovery audits. DOE conducts recovery activities
  including but not limited to prepayment review and approval of invoices; performing
  ...
  and interim and close-out reviews of contracts and grants, reviews of grant credits
  in the Automated Standard Application for Payments (ASAP), and results from travel
  audits.
detail_Recovery_Not_Cost_Effective_Programs: 1) Vendors/Contracts; 2) Benefits - Payroll;
  3) Benefits - Travel; 4) Financial Assistance Awards; 5) Loans; and 6) Other.
detail_Risks_Additional_Information: 'DOE evaluates eight of the Office of Management
  ...
  C, as applicable to DOE;  plus five other risk factors, as determined by DOE. In
  FY 2023, DOE''s
