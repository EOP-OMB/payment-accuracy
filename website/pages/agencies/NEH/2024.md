...
detail_DNP_Discussion: The Office of Grants Management (OGM) performs a DNP check
  prior to issuance of a grant award.  OGM does not award a recipient a grant award
  if there is a flag in DNP.
...
detail_Recommendations_To_Reduce_IP: Nothing has come to the OIG's attention that
  programs administered by NEH are susceptible to significant improper payments
...
detail_Recovery_Not_Cost_Effective_Justification: NEH did not conduct any recovery
  ...
  NEH has a 100% recovery/correction rate policy for any improper payment identified.
detail_Recovery_Not_Cost_Effective_Programs: For all NEH programs reported for this
  data call, conducting recovery audits is not cost effective because NEH has a 100%
  recovery/correction rate policy for any improper payment identified.
