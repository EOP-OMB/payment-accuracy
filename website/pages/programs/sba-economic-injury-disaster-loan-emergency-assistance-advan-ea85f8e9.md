...
- Agency_Needs_Satisfied: The agency has what is needed with respect to internal controls,
  ...
  Corrective_Actions_Proportion: Corrective actions, which typically include obtaining
    supporting documentation from the applicant, are completed within 15 days of being
    informed of the improper payment.  In addition, SBA provides quarterly training
    to loan processing staff on the causes of and prevention of improper payments.
  End_Date: 03/2022
  Future_Outlook_Has_Baseline: 'Yes'
  Future_Outlook_Reduction_Vs_Estimated: Because the EIDL Advance program ended on
    December 31, 2021, the improper payment estimates for FY 2023 will only consist
    of any advances that were disbursed after March 31, 2022, if any.
  ...
  Program_Additional_Information: The Economic Injury Disaster Loan Emergency Assistance
    (EIDL Advance) are funds awarded to existing COVID-EIDL applicants who meet certain
    eligibility criteria.  The EIDL Advances are similar to grants (without the typical
    requirements for grants) and are not required to be repaid.  There are two forms
    of EIDL Advances, Targeted EIDL Advance and Supplemental Targeted Advance.  Targeted
  ...
  overpayments:
    ...
    Overpayments_Within_Control_Amount: '766.34'
    Overpayments_Within_Control_Why: The most prevalent cause stemmed from processors
      failing to obtain the required income reduction from the applicant in order
      to qualify.  Additional causes for improper payments included processors failing
      to document the applicant's citizenship, existence of the business, or that
      the business was located in a low-income area.
...
- Actions_Taken:
  ...
  Confidence_Level: 95% to <100%
  Corrective_Actions_Proportion: The ongoing training and corrective actions required
    by Numbered Memo 22-04address current areas of concerns, allowing the PDC trainings
    to focus on identified areas. The certification required by Numbered Memo 22-04
    the PDC and Center Director establish accountability for trainings and corrective
    actions. It should be noted, there is no additional funding for this program.
  End_Date: 03/2023
  Future_Outlook_Has_Baseline: 'Yes'
  Future_Outlook_Reduction_Vs_Estimated: This program ended in 2022.  No additional
    funds were approved or awarded; therefore,  no reduction target was established.
  Hide_Improper_Payment_Estimates_Doughnut_Chart: false
  Hide_Improper_Payment_Estimates_Doughnut_Stats: false
  Hide_Overpayments_Outside_Data_Needed_Does_Not_Exist: true
  Hide_Overpayments_Outside_Data_Needed_Does_Not_Exist_2: true
  ...
  Start_Date: 04/2022
  Technical_IP_Amount: '0'
  Tolerable_Rate_Not_Determined_Reason: This program ended in 2022.  No additional
    funds were approved or awarded; therefore,  no tolerable rate  was established.
  Unknown_Curent_Year_Plus_1_Amount: 0
  Unknown_Payments_Rate: 0
  Year: 2023
  overpayments:
    ...
    Financial: 3.8025
    Inability_to_Access_Data: 0.0
    Overpayments_Within_Control_Amount: '5.07'
    Overpayments_Within_Control_Why: The overall root cause of overpayments was failure
      ...
      stemmed from failure to provide proof of citizenship, existence of the business,
      or that business was located in a low-income area, and required applicants missing
      from application. Corrective actions may include but are not limited to obtaining
      supporting documentation from the borrower, competing a loan modification, and/or
      adding clarifying comments to the case files. In addition, SBA provides reoccurring
      training to staff on causes and prevention of improper payments.
