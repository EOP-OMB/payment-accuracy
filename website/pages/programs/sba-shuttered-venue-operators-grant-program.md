...
- Hide_Improper_Payment_Estimates_Doughnut_Chart: true
  ...
  Improper_Payments_Rate: 0
  Insufficient_Documentation_to_Determine: 0.0
  No_Estimates_Why: The SVOG program was created as a temporary relief program in
    response to the COVID-19 pandemic, with most disbursements occurring within the
    first year.  Following guidance from OMB and the limitations outlined in Appendix
