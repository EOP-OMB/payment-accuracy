...
- Agency_Needs_Satisfied: As part of its strategic plan, AmeriCorps is prioritizing
  ...
  Margin_of_Error: '7.9'
  Non_Monetary_Loss_Amount: '0.066'
  ...
  overpayments_outside:
    ...
    Financial: 1.437
    Inability_to_Access_Data: 0.0
    Overpayments_Outside_Control_Amount: '1.437'
  underpayments:
    Address_Location: 0.0
    Contractor_Provider_Status: 0.0
    Data_Needed_Does_Not_Exist: 0.0
...
- Actions_Taken:
  ...
  Future_Outlook_Reduction_Vs_Estimated: The reduction target equals the estimated
    future IP and UP rates. The agency assumes flat funding for the current year +1
    estimate, so the reduction target was used to calculate IP and UPs. The corrective
    actions developed in FY22, including enhanced trainings, may further reduce the
    future rates are targeting unknown payments, therefore that is where the reduction
    can be seen.
  Hide_Improper_Payment_Estimates_Doughnut_Chart: false
  Hide_Improper_Payment_Estimates_Doughnut_Stats: false
  ...
  Is_Lowest_IP_And_Unknown_Rate: 'No'
  Margin_of_Error: '6.6'
  Non_Monetary_Loss_Amount: '0.046'
  Outlays_Current_Year_Plus_1_Amount: 34.3649
  Payment_Accuracy_Rate: 84.35617634220864
  Program_Additional_Information: The Senior Companion Program continues to demonstrate
    a downward trend in improper payment rates and amounts. The improper payment rate
    for FY 2023 is below the statutory threshold and the agency intends to move the
    program into Phase 1 in FY 2024.
  Program_Design_or_Structural_Issue: 0.0
  Resources_Requested_For_IP: AmeriCorps did not request additional resources in its
    most recent budget submission to reduce improper payment rates.
  Start_Date: 04/2022
  Technical_IP_Amount: '0'
  ...
  Unknown_Due_To_Scenario_Not_Specified_Amount: '3.305'
  ...
  overpayments_outside:
    ...
    Financial: 2.025
    Inability_to_Access_Data: 0.0
    Overpayments_Outside_Control_Amount: '2.025'
    Overpayments_Outside_Control_Why: AmeriCorps awards grants only to eligible recipients
      ...
      to payment. All tested payments are made outside the agency by grantees. No
      overpayments are made within the agency’s control in the programs being reported.
  underpayments:
    Address_Location: 0.0
    Contractor_Provider_Status: 0.0
    Data_Needed_Does_Not_Exist: 0.0
...
Outlays: 0
Overpayment_Amounts: '[1.437, 2.025]'
Payment_Accuracy_Amounts: '[27.532000000000004, 28.989000000000004]'
