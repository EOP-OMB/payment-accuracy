...
- ActionsTakenAdditionalData:
    ...
    Sufficiency: The small amounts identified relative to the program outlays does
      not normally present an opportunity to efficiently use resources to attempt
      to recover.
  Answers:
  - Agency: ED
    Answer: '55570.27'
