...
- Indent: 1
  ...
  Type: REGULAR
SurveyData:
- Answer: No improper payments were identified. In the instance there were payments
    identified, the proper recovery action would be determined on a case-by-case basis.
...
- Answer: '0.0'
  ...
  Subheading: ''
  Type: PERCENTAGE
- Answer: The PIIA also requires agencies to conduct payment-recapture audits for
...
permalink: /resources/congressional-reports/2025_FLRA_5
